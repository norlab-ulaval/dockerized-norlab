...
NABO_ROOT_DIR="$( realpath "$(dirname "${_PATH_TO_SCRIPT}")/../../" )"
cd "${NABO_ROOT_DIR}"
...
#bash dockerized-norlab-scripts/build_script/dn_build_all.bash -- build --dry-run dependencies dependencies-doc

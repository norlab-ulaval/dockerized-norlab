...
if [[ ${DN_ENTRYPOINT_TRACE_EXECUTION} == true ]]; then
  echo -e "\033[1;33m[DN trace]\033[0m Execute project-deploy/dn_entrypoint.attach.bash"
fi
...
if [[ -f /entrypoints/project-deploy/dn_entrypoint.attach.callback.bash ]]; then
  source /entrypoints/project-deploy/dn_entrypoint.attach.callback.bash || exit 1
else

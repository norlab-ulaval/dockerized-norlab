...
# Inspired from https://roboticseabass.com/2023/07/09/updated-guide-docker-and-ros2/
{
  ...
  #mkdir -p "/home/${DN_PROJECT_USER}"
  chown -R "${DN_PROJECT_UID}":"${DN_PROJECT_GID}" "/home/${DN_PROJECT_USER}"
...
# ....Simlink and change ownership of DN container-tools...........................................
{
  ...
  # (Priority) ToDo: validate deleting ≥≥ on task RLRP-213 end >> delete next line ↓↓
